...
@WebServlet("/updateBambooForm.do")
public class updateBambooForm extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("/work_kjy/bamboo/updateBamboo.jsp").forward(request, response);
	}
