...
/*
 *  이 예제는 작성한 서블릿을 애노테이션(@WebServlet)을 이용해서 등록하여 실행하는 예제이다.
 *  
 ...
 *  	예) 등록 URL패턴이 1개일 경우 : urlPatterns = "/nrl1" 또는 urlPatterns=({"/url1"})  
 *  	    등록 URL패턴이 복수일 경우 : urlPatterns = {"/url1", "/url2", ... }
 *  3) value : urlPatterns와 동일한 기능을 한다. 
 *  4) dexcription : 주석(설명글)을 기술한다.
 */
...
public class ServletTest02 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("애노테이션으로 설정한 두번째 서블릿 입니다.<br>");
