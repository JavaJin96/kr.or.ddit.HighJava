 ...
 *  
 *  Comparable은 Collection에 추가되는 데이터 자체의 정렬 기준을 넣고 싶을 때 구현하는 인터페이스이고, (내부정렬기준)
 *  
 ...
 *  
 *  String클래스, Wrapper클래스, Data클래스, File클래스에는 내부정렬 기준이 구현되어 있다.
 * 
 */
...
public class ListSortTest {
	...
	public static void main(String[] args) {
		...
		// Collections.sort() 메서드는 기본적으로 Collection에 포함된 데이터의 내부 정렬 기준으로 정렬한다.
...
// 외부 정렬 방식을 정해주는 Class를 만든다. (외부 정렬 기준 클래스)
